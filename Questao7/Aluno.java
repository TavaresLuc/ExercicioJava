...
public class Aluno {
	...
	public int avalia() {
		...
		if(getMedia() >= 7) {
			...
			System.out.println(getNome() + " vai para o exame final.");
	...
	public static void informa() {
		System.out.println("A quantidade de alunos aprovados é de: " + Aluno.aprovado);
		System.out.println("A quantidade de alunos em exame final é de: " + Aluno.exame);
		System.out.println("A quantidade de alunos reprovados é de: " + Aluno.reprovado);
